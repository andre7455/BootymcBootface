      ...
      <div class="container">
        <form>
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
              <div class="form-group">
                <input type="submit" class="form-control btn-primary" value="Search Boat Now" />
              </div>
            </div>
          </div>
        </form>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-12">
              <h2 class="heading"> Boat Categories </h2>
              <div class="r-best-vehicle-list-outer">
                <div class="r-best-leftbar">
                  <ul class="pl-0 mb-0 r-best-vehicle-types r-best-vehicle-category">
                    <li><span> <i class="fa fa-star"></i> Popular Boats</span></li>
                ...
                <div class="row">
                  ...
                  <div class=" col-lg-6 col-md-12 col-sm-12">
                    <div class="r-car-filter-wrapper">
                      <span class="r-filter-text"> Show Boats : </span>
                      <select class="r-show-cars-filter">
                        ...
                        <option value="30"> 30 Boats </option>
                      </select>
                    ...
                    <div class="r-best-offer-single">
                      <div class="r-best-offer-in">
                        ...
                        <div class="r-offer-rewst-this">
                          <span class="text-uppercase">Rent this Boats</span>
                        </div>
                      </div>
                    </div>
                  </div>
