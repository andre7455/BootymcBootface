              ...
              <div id="r-quote-carousel" class="carousel slide">
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item">
                    <p>“This was our first time renting from Royal Cars and we were very pleased with the whole
                      ...
                      <div class="r-best-vehicle-single">
                        ...
                        <div class="r-best-vehicle-content">
                          ...
                          <div class="clearfix">
                            ...
                            <span class="r-engine"><img src="assets/images/meter-icon.png" class="d-inline-block"
                                alt="">2.3K CC</span>
                          </div>
                          <ul>
                            <li><i class="fa fa-cogs"></i><span>MANUAL</span></li>
              ...
              <ul class="nav nav-tabs r-faq-option-tab" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="faq-03-tab" data-toggle="tab" href="#faq-03" role="tab" aria-controls="faq-03"
                    aria-selected="false"><i class="fa fa-car"></i>Cars Features</a>
                </li>
              </ul>
            </div>
          </div>
