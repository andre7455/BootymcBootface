    ...
    <section class="r-car-info-wrapper">
      <div class="container">
        <div class="r-car-info-header clearfix">
          <div class="r-car-top-info">
            <div class="r-car-rating">
              ...
              <i class="fa fa-star"></i>
              <i class="fa fa-star"></i>
              <span class="r-rating-text"> BOAT RATING: 5/5 </span>
            </div>
            <h2 class="r-car-name"> Ship <span>M Class</span> </h2>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
              <div class="r-car-info-content">
                ...
                <h2 class="r-product-name"> Ship <span>GTR</span> </h2>
                <p class="r-product-description">This was our first time renting from CoralYachts and we were very
        ...
        <div class="r-similar-product">
          <h2 class="heading"> Similar Boats </h2>
            ...
            <div class="r-best-offer-single">
              <div class="r-best-offer-in">
                ...
                <div class="r-offer-rewst-this">
                  <span class="text-uppercase">Rent this Boat</span>
                </div>
              </div>
            </div>
