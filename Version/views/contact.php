    ...
    <div class="row clearfix">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="r-contact-address">
          ...
          <div class="r-contact-img"><img src="assets/images/contact-img01.jpg" class="img-fluid d-block m-auto" alt="">
          </div>
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="r-contact-address">
          ...
          <div class="r-contact-img"><img src="assets/images/contact-img02.jpg" class="img-fluid d-block m-auto" alt="">
          </div>
          <div class="address address-cnt"><i class="fa fa-map-marker"></i><b>300</b> Pennsylvania EV, USA</div>
          <div class="call address-cnt"><i class="fa fa-phone"></i><b>+100</b>-1212-2000</div>
          <div class="mail address-cnt"><i class="fa fa-envelope"></i>info@royalcars.com</div>
  ...
  <div class="r-get-in-touch">
    <div class="container">
      ...
      <div class="r-get-form">
        <div class="clearfix">
          <div class="form-group"><input required="" name="userName" id="userName" type="text" placeholder="User name">
          </div>
          <div class="form-group"><input required="" name="userEmail" id="userEmail" type="email"
              placeholder="Email Address"></div>
        </div>
        <div class="form-group"><input type="text" required="" name="subject" id="subject" placeholder="Title Message">
        </div>
