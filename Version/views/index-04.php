...
?>
            <div class="r-slider owl-carousel" id="defaultHomeSlider">
              ...
              <div class="r-slider-item">
                ...
                <div class="container">
                  <div class="r-slider-top-content">
                    <h1>Kia Rio <span>z</span></h1>
                    <h4>FOR RENT <strong>$50</strong> PER DAY</h4>
              ...
              <div class="row clearfix">
                 ...
                 <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="r-advantages-box">
                      ...
                      <div class="head">All Type & Brand Cars Manufacturer</div>
                      <div class="sub-text">Call us Anywhere Anytime</div>
                    </div>
                  </div>
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                      <div class="r-advantages-box">
                        ...
                        <div class="head">The Most Cheapest Rent Car</div>
                        <div class="sub-text">250+ Locations</div>
                      </div>
                  </div>
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                      <div class="r-advantages-box">
                        ...
                        <div class="head">10+ Years Experienced Drivers</div>
                        <div class="sub-text">250+ Locations</div>
                      </div>
                  </div>
              </div>
          ...
          <div class="r-new-member r-who-we-outer r-new-member-dark">
            <div class="container">
              ...
              <div class="row clearfix mb-5 r-who-we-small">
                <div class="col-lg-6">
                  <p class="mb-0">We know the difference is in the details and that’s why our car rental services, in the tourism and business industry, stand out for their quality and good taste Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </p>
                </div>
                <div class="col-lg-6">
                  <p class="blockquote">
                    We know the difference is in the details and that’s why our car rental services, in the tourism and business industry, stand out for their quality and good taste.
              ...
              <div class="r-btns pt-5 pb-2">
                <a href="#" class="btn btn-full">VIEW ALL VEHICLES</a>
                <a href="#" class="btn btn-full btn-dark">RESERVED CAR</a>
              </div>
            </div>
          </div>
        </section>
        <section>
          <div class="r-best-vehicles r-best-vehicles-trans">
            <div class="r-sec-head r-accent-color r-sec-head-v">
              <span>FEATURED CARS</span>
              <h2>Get Our <b>Best Offers.</b></h2>
            </div>
            <div class="container">
               <ul class="nav nav-tabs r-car-option-tab" id="myTab" role="tablist">
                <li class="nav-item">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="luxury" role="tabpanel" aria-labelledby="luxury-tab">
                  <div class="r-best-offer-list owl-carousel" id="similarProductCarousel-01">
                    <div class="r-best-offer-single">
                      <div class="r-best-offer-in">
                        <div class="r-offer-img">
                          <a class="d-inline-block" href="#"><img src="assets/images/car-6.png" class="img-fluid d-block m-auto" alt=""></a>
                ...
                <div class="tab-pane fade" id="family" role="tabpanel" aria-labelledby="family-tab">
                  <div class="r-best-offer-list owl-carousel" id="similarProductCarousel-02">
                    <div class="r-best-offer-single">
                      <div class="r-best-offer-in">
                        <div class="r-offer-img">
                          <a class="d-inline-block" href="#"><img src="assets/images/car-1.png" class="img-fluid d-block m-auto" alt=""></a>
                ...
                <div class="tab-pane fade" id="sport" role="tabpanel" aria-labelledby="sport-tab">
                  <div class="r-best-offer-list owl-carousel" id="similarProductCarousel-03">  
                    <div class="r-best-offer-single">
                      <div class="r-best-offer-in">
                        <div class="r-offer-img">
                          <a class="d-inline-block" href="#"><img src="assets/images/car-3.png" class="img-fluid d-block m-auto" alt=""></a>
        ...
        <section id="r-drivers">
          <div class="r-driver-blog-dark r-driver-blog-dark-theme-2">
            <div class="r-sec-head r-accent-color r-sec-head-s">
              <span>OUR PROFESSIONAL STAFF</span>
              <h2>Royal Cars <b>Drivers.</b></h2>
            </div>
            <div class="container">
              <div class="r-driver-blog r-dot-theme-dark">
                  <div class="owl-carousel" id="r-driver-row-slider">
                    <div class="row clearfix">
        ...
        <section id="r-get-in-touch">
          <div class="r-get-in-touch r-get-in-touch-dark">
            <div class="container">
              ...
              <div class="r-counter-section r-counter-with-bg r-counter-transparent-bg mt-100  mb-0">
                  <div class="container">
                      <div class="row">
              ...
              <div class="owl-carousel r-latest-news-list" id="r-latest-news-slider">
                <div class="r-latest-news-single">
                  ...
                  <div class="r-latest-news-content">
                    ...
                    <p> Lorem ipsum dolor sit amet, consectetuer the melt adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat adipiscing dolgedo.  </p>
            ...
            <div class="r-footer-strip">
              <div class="container">
                <div class="row clearfix">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <p class="r-copy-right-text">&copy;2017 <strong>RoyalCars.com</strong> by Last40</p>
                  </div>
                </div>
              </div>
            </div>
