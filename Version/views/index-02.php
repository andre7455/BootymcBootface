    ...
    <div class="row row-inputs">
      ...
      <div class="col-sm-6">
        <div class="form-group has-icon has-label date" id="datetimepicker3" data-target-input="nearest">
          ...
          <input type="text" class="form-control" data-toggle="datetimepicker" data-target="#datetimepicker3"
    ...
    <div class="row row-inputs">
      ...
      <div class="col-sm-6">
        <div class="form-group has-icon has-label date" id="datetimepicker5" data-target-input="nearest">
          ...
          <input type="text" class="form-control" data-toggle="datetimepicker" data-target="#datetimepicker5"
            placeholder="20:00 AM">
          <span class="form-control-icon"><i class="fa fa-clock-o"></i></span>
        </div>
      </div>
      ...
      <div class="row clearfix">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="r-about-info-content">
            ...
            <a href="#" class="btn-primary">VIEW ALL VEHICLES</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row clearfix r-best-offer-list owl-theme owl-carousel" id="r-best-offers">
          ...
          <div class="r-best-offer-single">
            <div class="r-best-offer-in">
              <div class="r-offer-img">
                <a class="d-inline-block" href="#"><img src="assets/images/best-01.jpg" class="img-fluid d-block m-auto"
                    alt=""></a>
                <a href="car-booking.html" class="d-block">
        ...
        <div class="">
          <div class="r-best-offer-single">
            <div class="r-best-offer-in">
              <div class="r-offer-img">
                <a class="d-inline-block" href="#"><img src="assets/images/best-02.jpg" class="img-fluid d-block m-auto"
                    alt=""></a>
                <a href="car-booking.html" class="d-block">
                  <div class="r-offer-img-over">
                    <i class="fa fa-search"></i>
        ...
        <div class="">
          <div class="r-best-offer-single">
            <div class="r-best-offer-in">
              <div class="r-offer-img">
                <a class="d-inline-block" href="#"><img src="assets/images/best-03.jpg" class="img-fluid d-block m-auto"
                    alt=""></a>
                <a href="car-booking.html" class="d-block">
                  <div class="r-offer-img-over">
                    <i class="fa fa-search"></i>
          ...
          <div id="r-quote-carousel" class="carousel slide">
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item">
                <p>“This was our first time renting from Royal Cars and we were very pleased with the whole experience.
                  Your price was lower than other companies. Our rental experience was good from start to finish, so
                  we’ll be back in the future lorem ipsum diamet.”</p>
              </div>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="business-tab" data-toggle="tab" href="#business" role="tab"
              aria-controls="business" aria-selected="true">Business Cars</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="luxury-tab" data-toggle="tab" href="#luxury" role="tab" aria-controls="luxury"
              aria-selected="false">Luxury cars</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="family-tab" data-toggle="tab" href="#family" role="tab" aria-controls="family"
              aria-selected="false">Family Cars</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="sport-tab" data-toggle="tab" href="#sport" role="tab" aria-controls="sport"
              aria-selected="false">Sport Cars</a>
          </li>
        </ul>
              ...
              <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                  <div class="r-car-info-content">
                    ...
                    <p class="r-product-description">This was our first time renting from Royal Cars and we were very
                      pleased with the whole experience. Your price was lower than other companies.</p>
          ...
          <div class="tab-pane fade" id="luxury" role="tabpanel" aria-labelledby="luxury-tab">
            <div class="r-car-whole-info">
              <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                  <div class="r-car-product-carousel-wrapper">
                    <div class="r-car-product-carousel owl-carousel" data-slider-id="r-product-slider-01"
                      id="productSlider-01">
                      <div class="item">
                        <img src="assets/images/car-slider-img-2.jpg" alt="" class="img-fluid" />
                      </div>
          ...
          <div class="tab-pane fade" id="family" role="tabpanel" aria-labelledby="family-tab">
            <div class="r-car-whole-info">
              <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                  <div class="r-car-product-carousel-wrapper">
                    <div class="r-car-product-carousel owl-carousel" data-slider-id="r-product-slider-02"
                      id="productSlider-02">
                      <div class="item">
                        <img src="assets/images/car-slider-img-3.jpg" alt="" class="img-fluid" />
                      </div>
          ...
          <div class="tab-pane fade" id="sport" role="tabpanel" aria-labelledby="sport-tab">
            <div class="r-car-whole-info">
              <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                  <div class="r-car-product-carousel-wrapper">
                    <div class="r-car-product-carousel owl-carousel" data-slider-id="r-product-slider-03"
                      id="productSlider-03">
                      <div class="item">
                        <img src="assets/images/car-slider-img-4.jpg" alt="" class="img-fluid" />
                      </div>
  ...
  <div class="r-newsletter-suscribe">
    <div class="container">
      <div class="r-newsletter-head">
        <img src="assets/images/logo-with-text.png" class="d-block img-fluid m-auto" alt="">
      </div>
      <div class="r-newsletter-form">
        ...
        <form action="#">
          <div class="r-newsletter">
            ...
            <button class="btn btn-full">SUBSCRIBE NOW</button>
          </div>
        </form>
      </div>
    </div>
          ...
          <div class="r-accordion">
            ...
            <div class="r-accordion-body">
              <p>
                ...
                laoreet dolore magna aliquam erat volutpat adipiscing dolgedo.
              </p>
            </div>
          </div> <!-- /r-accordion -->
          <div class="r-accordion">
...
<div class="content-area">
  <div class="google-map r-map-large">
    <div id="map-canvas"></div>
  </div>
  <div class="r-car-search r-search-map-over r-search-map-full">
    <div class="container">
