...
?>s
            <div class="r-slider owl-carousel" id="defaultHomeSlider">
              <div class="r-slider-item">
                <img src="assets/images/main-slider-06.jpg" class="img-fluid d-block m-auto" alt="">
                <div class="container">
                  <div class="r-slider-top-content float-left text-left">
                    <h4 class="text-gray-dark mb-3">FOR RENT <strong>$100</strong> PER DAY</h4>
                    <h1 class="mb-3"><b class="text-gray-dark">Nissan</b> <span>RX8</span></h1>
                    <ul class="pl-0 mb-4">
                    ...
                    <a href="#" class="btn btn-outlined"> Reserved Now </a>
                  </div>
                </div>
              </div> 
            </div> 
                ...
                <form action="#">
                    ...
                    <div class="row row-inputs">
                      ...
                      <div class="inner col-12 clearfix">
                          <button type="submit" class="btn m-auto d-block float-right btn-full">RESERVED CAR</button>
                      </div>
                    </div>
                </form>
              </div>
              ...
              <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <div class="r-about-info-img">
                    <img src="assets/images/about-img-02.png"  class="img-fluid d-block m-auto" alt="">
                  </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
